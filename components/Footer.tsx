        ...
        <div className="grid grid-flow-col gap-4">
          <a>
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              className="fill-current hover:fill-blue-500 duration-300"
              cursor="pointer"
            >
          ...
          <a>
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              className="fill-current hover:fill-red-600 duration-300"
              cursor="pointer"
            >
          ...
          <a>
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              className="fill-current hover:fill-blue-600 duration-300"
              cursor="pointer"
            >
